...
export default function PathCard({
  ...
  return (
    <Link href={`/paths/${slug}`} className="group block">
      <div className="rounded-lg border bg-card transition-all duration-300 ease-out hover:-translate-y-1.5 hover:scale-[1.01] hover:shadow-md hover:border-primary/30 dark:hover:border-primary/40 p-5 h-full flex flex-col gap-3">
