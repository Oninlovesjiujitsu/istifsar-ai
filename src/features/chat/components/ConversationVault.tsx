...
import { deleteConversation, updateConversationTitle } from '@/src/features/chat/actions/conversation';
          ...
          {isMenuOpen && (
            <div className="absolute right-0 mt-1 w-32 bg-[#141414] border border-white/10 rounded-md shadow-lg overflow-hidden z-50 py-1">
              ...
              <button
                ...
                className="w-full text-left px-3 py-2 text-xs text-destructive hover:bg-white/10 flex items-center gap-2"
              >
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
