...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    try {
      ...
      // Recursive character splitting (highly optimized for speed and overlap)
      const rawChunks = chunkDocumentRecursive(text, CHUNK_SIZE, CHUNK_OVERLAP);
      ...
      // Embed assembled chunks for high-fidelity storage vectors
